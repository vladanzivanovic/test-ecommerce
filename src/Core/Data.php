...
//        parent::__construct($this->connectors['host'], $this->connectors['user'], $this->connectors['password'], $database);

//        if (conn()) {
//            throw new ConnectException(mysqli_connect_error(), mysqli_connect_errno());
//        }

//        $this->_inUse = $database;
...
//        var_dump($prepared, $this->getQueryBuilder()->getParameters()); exit();
